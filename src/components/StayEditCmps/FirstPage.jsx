...
export function FirstPage() {
    return (
        <section className="firstpage-edit">
            ...
            <div className="video-container"><video src="https://stream.media.muscache.com/zFaydEaihX6LP01x8TSCl76WHblb01Z01RrFELxyCXoNek.mp4?v_q=high" autoPlay="" playsInline="" className="video"></video></div>
